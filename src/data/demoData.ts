...
export const demoData: BusinessPlanData = {
    ...
    // ── 7P Marketing Mix ──────────────────────────────────────────
    marketingP1_product: "Trois offres complémentaires : (A) Forfait Performance Mensuel (SEA/SMA avec reporting KPI garanti), (B) Projets Web & E-commerce (sites vitrines et boutiques SEO-friendly), (C) Audit & Stratégie Digitale (diagnostic 360° + feuille de route 12 mois). Différenciation : engagement contractuel sur les résultats (ROI minimum garanti) et reporting transparent via dashboard temps réel.",
    marketingP2_price: "Positionnement premium-accessible : Forfait Mensuel à partir de 800 TND/mois HT (vs 1 500–3 000 TND des agences de Tunis centre). Projets Web : 3 500 à 15 000 TND selon complexité. Politique de fidélisation : remise de 10 % dès 6 mois d'engagement. Paiement à 30 jours fin de mois pour les clients institutionnels.",
    marketingP3_place: "Vente directe B2B via démarchage téléphonique et LinkedIn (principal canal). Présence physique au Lac 2 pour les rendez-vous clients. Service 100 % digitalisable (livraison à distance pour clients hors Tunis). Extension prévue vers Sfax et Sousse en année 3 via réseau de partenaires-revendeurs.",
    marketingP4_promotion: "Plan de communication intégré : (1) Blog expert SEO (50 articles/an ciblant les mots-clés PME tunisiennes), (2) LinkedIn Ads : budget 500 TND/mois, ciblage PDG/Directeurs Commerciaux, (3) Offre 'Audit Gratuit' pour générer des leads qualifiés, (4) Présence aux salons Tunisia Tech Forum et Forum de l'Entreprise CONECT, (5) Programme de recommandation client (commission 5 % sur chaque referral converti).",
    marketingP5_people: "Équipe fondatrice hautement qualifiée : Directeur Général (MBA Marketing Digital, 8 ans d'expérience internationale), 2 Community Managers certifiés Meta & Google Ads, 1 Développeur Full-Stack. Culture 'Client First' : formation trimestrielle aux nouvelles tendances, charte de réponse client sous 2 heures ouvrées.",
    marketingP6_process: "Parcours client en 5 étapes : (1) Prise de contact & audit gratuit (J0–J2), (2) Présentation de la proposition commerciale personnalisée (J3–J5), (3) Signature contrat & onboarding (J6–J10), (4) Déploiement campagnes & outils de tracking (J10–J17), (5) Reporting mensuel + réunion bilan & optimisation. Outil CRM : HubSpot pour suivi des leads et fidélisation.",
    marketingP7_physicalEvidence: "Bureau de 85 m² en open space moderne au Lac 2 : salle de réunion équipée (écran 65', visioconférence), charte graphique premium (logo, kakémonos, plaquettes A4 quadrichromie). Présence digitale : site web vitrine responsive avec portfolio clients, page LinkedIn active (>500 abonnés cible an 1), avis Google Business. Tenue professionnelle uniforme pour les déplacements clients.",
